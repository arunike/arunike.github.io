    ...
    <Container fluid className="project-section">
        ...
        <div className="d-flex mt-4 ms-5">
          ...
          <ul className="course_taken_right_text list">
            <strong> xxx </strong> <br />
              <strong>Professor: </strong> xxx <br />
              <strong>Rating: </strong> <AiFillStar color="#FFDB58"/> <AiFillStar color="#FFDB58"/> <br />
              <strong>When: </strong> Fall 2024 <br />
              <strong>Workload: </strong> <AiFillStar color="#FFDB58"/> <AiFillStar color="#FFDB58"/>
            </ul>
        </div>
      </div> */}
        ...
        <div className="d-flex mt-4 ms-5">
          ...
          <ul className="course_taken_right_text list">
            <strong>COMP SCI 252 - Introduction to Computer Engineering </strong> <br />
              <strong>Professor: </strong> Karu Sankaralingam <br />
              <strong>Rating: </strong> <AiFillStar color="#FFDB58"/> <AiFillStar color="#FFDB58"/>  <br />
              <strong>When: </strong> Fall 2020 <br />
              <strong>Workload: </strong> <AiFillStar color="#FFDB58"/> <AiFillStar color="#FFDB58"/> <br />
              <strong>Description: </strong> In this course, you'll explore the construction of logic components using transistors and grasp foundational concepts of Boolean algebra. Dive into the essentials of combination logic design and synchronous sequential logic design. Understand the fundamentals of computer organization and get acquainted with introductory machine and <strong>assembly language</strong>.
            </ul>
        </div>
      </div>
      ...
      <div className="container mt-5 ">
        <div className="d-flex mt-4 ms-5">
          ...
          <ul className="course_taken_right_text list">
            ...
            <strong>Professor: </strong>  Michael Doescher <br />
            <strong>Rating: </strong>  <AiFillStar color="#FFDB58"/> <br />
            <strong>When: </strong> Fall 2021 <br />
            <strong>Workload: </strong> <AiFillStar color="#FFDB58"/> <AiFillStar color="#FFDB58"/> <AiFillStar color="#FFDB58"/> <AiFillStar color="#FFDB58"/> <br />
      ...
      <div className="container mt-5 ">
        <div className="d-flex mt-4 ms-5">
          ...
          <ul className="course_taken_right_text list">
            <strong>STAT 240 - Data Science Modeling I </strong> <br />
            <strong>Professor: </strong> Bi Cheng Wu <br />
            <strong>Rating: </strong> <AiFillStar color="#FFDB58"/> <AiFillStar color="#FFDB58"/> <AiFillStar color="#FFDB58"/> <br />
            <strong>When: </strong> Spring 2022 <br />
            <strong>Workload: </strong> <AiFillStar color="#FFDB58"/> <AiFillStar color="#FFDB58"/> <br />
            <strong>Description: </strong> In this course, you'll immerse yourself in reproducible data modeling and statistical analysis. Explore the integrated statistical computing environment, the intricacies of data wrangling, and the versatility of the <strong>R</strong>. Dive into captivating data visuals and foundational probability concepts such as the binomial and normal distributions, and delve into data modeling. Master statistical inferences across various sample settings, simple linear regression, and seamlessly craft comprehensive reports using R Markdown. You'll apply these skills to a broad spectrum of data through practical exercises, addressing multifaceted analytical challenges.
            </ul>
        </div>
      </div>
      ...
      <div className="container mt-5 ">
        <div className="d-flex mt-4 ms-5">
          ...
          <ul className="course_taken_right_text list">
            ...
            <strong>Professor: </strong>  Remzi Arpaci-Dusseau <br />
